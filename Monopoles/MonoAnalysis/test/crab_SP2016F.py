...
config.General.requestName = 'SP2016F_HLT'
config.General.workArea = 'DataSP2016F'
config.General.transferOutputs = True
config.General.transferLogs = True

config.section_('JobType')
config.JobType.psetName = 'ntuple2016F.py'
config.JobType.pluginName = 'Analysis'
#config.Data.lumiMask = 'Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt'
config.JobType.outputFiles = ['2016F_HLT.root']
...
config.Data.inputDataset ='/SinglePhoton/Run2016F-EXOMONOPOLE-07Aug17-v1/USER'
...
config.Data.outputDatasetTag = 'CRAB3_SinglePh2016F_2019'
