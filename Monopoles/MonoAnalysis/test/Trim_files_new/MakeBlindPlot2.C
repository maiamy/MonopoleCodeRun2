...
TH2F *MakeBlindPlotSig(TTree *Mono, int Unblind=3){
    ...
    double x[4]={0, 80, 95, 105};
    double y[4]={0, 14, 16, 60};
    ...
    float Run, Event, SatSubHits, SubHits, Dist, HIso, XYPar0, XYPar2, RZPar0, RZPar1, RZPar2, seedFrac,E, passHLT_Photon175;
    ...
    Mono->SetBranchAddress("E", &E);
    Mono->SetBranchAddress("passHLT_Photon175", &passHLT_Photon175);
