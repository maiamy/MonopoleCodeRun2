...
// HLTPhoton160, HLTMET, HLTPFMET170, passGeneral;
void Trim(TTree *OldTree, string FileName, bool Refit=false, TEventList *Passed=NULL){
  TFile OutFile(FileName.c_str(), "recreate");
  TNtuple NewTree("monopoles", "monopoles", "run:event:Dist:SubHits:SatSubHits:seedFrac:E:TIso:HIso:XYPar0:XYPar1:XYPar2:RZPar0:RZPar1:RZPar2:RZErr2:Eta:Phi:passHLT_Photon175");
  ...
  OldTree->SetBranchAddress("passHLT_Photon175",&passHLT_Photon175);
